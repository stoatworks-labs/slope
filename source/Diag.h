...
/**
    ...
    **A buffer that could not be allocated.** This plugin holds one sample
    buffer and two pairs of state buffers, samples wide and lines x coders
    tall, all RGBA32F, and the failure mode when the driver says no is a
    black frame with nothing to explain it. What goes in the log is the size
    asked for: at 4K, RGB, one pixel a sample, the five come to about 530 MB.
*/
namespace slopefx::diag
{
