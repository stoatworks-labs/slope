/*
 * Stoatworks Labs - About window data for Slope.
 *
...
{
    inline constexpr auto name = "Slope";
    inline constexpr auto slug = "slope";
    inline constexpr auto hook = "A one-bit delta modulator, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/slope/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/slope/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/slope";
